...
export default function ProfileScreen() {
  ...
  useEffect(() => {
    const getAppUserIDAndSubscription = async () => {
      try {
        ...
        console.error("Error getting app user ID and subscription:", error);
        setHasSubscription(false);
      }
    };
    getAppUserIDAndSubscription();
  }, []);
...
Thank you!`;
  ...
  const handleBackNavigation = async () => {
    if (hasSubscription === true) {
      // User has subscription - allow normal back navigation
      router.back();
    } else {
      // User doesn't have subscription - redirect to paywall so they can subscribe or dismiss again
          ...
          onPress: async () => {
            ...
            try {
              ...
              if (error) {
                Alert.alert(
                  "Error",
                  "Failed to delete projects from cloud: " + error.message
                );
              ...
              Alert.alert(
                "Error",
                "Failed to clear projects: " + (error as Error).message
              );
            }
            setClearingProjects(false);
          },
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                This ID helps our support team assist you with subscription and
                account issues.
              </Text>
              <TouchableOpacity
              ...
              >
                Contact our support team for help with subscriptions, billing,
                or app features.
              </Text>
            ...
            >
              ...
              >
                This will permanently delete all of your projects from both your
                device and the cloud. This action cannot be undone.
              </Text>
              <TouchableOpacity
                style={{
